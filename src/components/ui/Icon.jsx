// Minimal stroke icon set — no icon library dependency, no emoji (brand rule).
...
export function Icon({ name, size = 16, flip = false, className = "", ...rest }) {
  if (name === "whatsapp") {
    return (
      <svg
  ...
  return (
    <svg
      className={`ic ${flip ? "ic--flip" : ""} ${className}`}
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill="none"
